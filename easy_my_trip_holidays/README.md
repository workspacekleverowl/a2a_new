...
```bash
cd flight_agent && source .venv/bin/activate && python __main__.py
```

**Terminal 2: Start the Hotel Agent**
```bash
cd hotel_agent && source .venv/bin/activate && python __main__.py
```

**Terminal 3: Start the Cab Agent**
```bash
cd cab_agent && source .venv/bin/activate && python __main__.py
```

**Terminal 4: Start the Activity Agent**
```bash
cd activity_agent && source .venv/bin/activate && python __main__.py
```

**Terminal 5: Start the Weather Agent**
```bash
cd weather_agent && source .venv/bin/activate && python __main__.py
```

**Terminal 6: Start the Budget Agent**
```bash
cd budget_agent && source .venv/bin/activate && python __main__.py
```

**Terminal 7: Start the Document Agent**
```bash
cd document_agent && source .venv/bin/activate && python __main__.py
```

**Terminal 8: Start the Food Agent**
```bash
cd food_agent && source .venv/bin/activate && python __main__.py
```

**Terminal 9: Start the Currency Agent**
```bash
cd currency_agent && source .venv/bin/activate && python __main__.py
```
